...
class EmployeeRestControllerTest {
	...
	void testInsertEmployee() {
		Employee emp = new Employee(123, "HITESH", 35000);
	...
	void testUpdateEmployee() {
		//restTemplate.put(null, restTemplate);
	}
	...
	void testDeleteById() {
//		int eid = 123;
//		restTemplate.delete("http://localhost:8080/api/employees/delete/"+eid, Employee.class);
//		
//		
//		ResponseEntity<Employee>  response = restTemplate.getForEntity("http://localhost:8080/api/employees/get/"+eid, Employee.class);
//		Employee e1 = response.getBody();
//		assertEquals(123, e1.getEid());
//		
		}
